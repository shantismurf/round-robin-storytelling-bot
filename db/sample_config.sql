...
-- Setup embed field headers (≤256 chars)
('txtSetupEmbedTitleFeed', 'Story Feed Channel (This is where all story threads and activity will be posted.)', 'en', 1),
('txtSetupEmbedTitleMedia', 'Media/Image Channel (This is a repository for all story images and should be a private channel. If blank, images in stories is disabled.)', 'en', 1),
('txtSetupEmbedTitleAdminRole', 'Admin Role (Optional, if blank the server admins will be able to manage stories and users.)', 'en', 1),
('txtSetupEmbedTitleRestrictedFeed', 'Restricted Feed Channel (This should be in an age-restricted channel if your server is not 18+.)', 'en', 1),
('txtSetupEmbedTitleRestrictedMedia', 'Restricted Media Channel (This should also be a private channel, and age-restricted just in case.)', 'en', 1),
('txtSetupEmbedTitleRoundupChannel', 'Weekly Roundup Channel (Where do you want a weekly activity summary posted? Feature is disabled if this is blank.)', 'en', 1),
('txtSetupEmbedTitleRoundupDay', 'Day to Post Roundup', 'en', 1),
('txtSetupEmbedTitleRoundupHour', 'Hour to Post Roundup', 'en', 1),
