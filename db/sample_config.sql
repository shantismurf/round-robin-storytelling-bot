...
('lblMyStoryManageAO3', 'AO3 Name', 'en', 1),
...
('btnJoinSetAO3', 'Set AO3 Username', 'en', 1),
...
('txtJoinDMSent', 'Check your DMs to complete joining this story!', 'en', 1),
('txtJoinDMFailed', 'I couldn''t send you a DM. Please enable DMs from server members and try again, or use /story join instead.', 'en', 1),
...
('txtHelp1FindJoin', '- `/story list` — Browse stories. Filter by: `all` · `joinable` · `mine` · `active` · `paused`\n- `/story join [id]` — Join a story as a writer\n- `/story read [id]` — Read a story page by page, and edit entries if you have permission. Includes a button to export the story as an HTML file.', 'en', 1),
...
('txtHelp1WriteNormal', '- Each turn will have its own thread for you to write your entry (private or public depending on story settings). You can submit as many posts as you''d like, including images in the order you want them to appear, using standard Discord markdown formatting, and you can edit posts as often as you like until you''re done. When you click ✅ **Finalize Entry** the bot will pull it all together, ignoring posts from other users or from the bot, for you to review and submit. Click ⏭️ **Skip Turn** to pass.', 'en', 1),
('txtHelp1WriteNormalNoMedia', '- Each turn will have its own thread for you to write your entry (private or public depending on story settings). You can submit as many posts as you''d like, using standard Discord markdown formatting, and you can edit posts as often as you like until you''re done. When you click ✅ **Finalize Entry** the bot will pull it all together, ignoring posts from other users or from the bot, for you to review and submit. Click ⏭️ **Skip Turn** to pass.', 'en', 1),
...
('txtHelp1ManageParticipation', '- `/mystory pass [id]` — Skip your current turn\n- `/mystory leave [id]` — Leave a story\n- `/story edit [id]` — Edit one of your finalized entries *(admins can edit any entry)*\n- `/story close [id]` — Close a story *(story creator or admin)*', 'en', 1),
...
('txtAdminHelpManageUser', 'Opens a management panel. Without a user specified it will show story management settings (same as `/story manage`). With a user, it opens a user management panel — pause, unpause, remove, or update their AO3 name using buttons.', 'en', 1),
...
('txtAdminAO3NameSuccess', '✅ AO3 name for **[user_name]** updated to **[ao3_name]**.', 'en', 1),
...
('lblManageUserAO3', 'AO3 Name', 'en', 1),
