...
('txtMyHelpPause', '- `/mystory pause [id]` — Step out of the turn rotation temporarily. Omit the ID to pause all active stories at once. If it''s your turn when you pause, it will be passed automatically.\n- `/mystory resume [id]` — Rejoin the rotation. You''ll be selected the next time the cycle reaches you.\n\nPausing holds your place in the story. To leave permanently, use `/mystory leave`.', 'en', 1),
...
('lblAdminHelpManageUser', '/storyadmin manageuser <action> <story_id> <user>', 'en', 1),
('txtAdminHelpManageUser', '- **pause** — Temporarily pauses a writer. If it''s their turn, advances to the next writer automatically.\n- **unpause** — Restores a paused writer to active rotation.\n- **remove** — Permanently removes a writer. Advances the turn if needed; auto-closes the story if they were the last writer.\n- **ao3name** — Updates a writer''s AO3 display name. Leave the name blank to clear it.', 'en', 1),
