...
('txtSetupFeedChannelPlaceholder', 'Paste the channel mention or ID, e.g.  `#story-feed`. This is where bot activity and story threads will be posted.', 'en', 1),
('lblSetupMediaChannel', 'Media/Image Channel (optional)', 'en', 1),
('txtSetupMediaChannelPlaceholder', 'Paste the channel mention or ID, e.g. `#story-images`. If not provided, images will not be saved in normal mode stories.', 'en', 1),
('lblSetupAdminRole', 'Admin Role Name (optional)', 'en', 1),
('txtSetupAdminRolePlaceholder', 'Exact role name, e.g. Round Robin Admin. If not provided, server admins can use all `/storyadmin` commands.', 'en', 1),
