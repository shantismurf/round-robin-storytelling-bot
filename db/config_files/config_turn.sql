...
('txtDMTurnStartSlow', '🔵 **Your turn has started in [story_title]!** You can now write your part of the story in your turn thread: [turn_thread_link]\n-# This is a slow mode story — there is no turn timer. Take your time!\n-# Use /mystory help to see the commands available to writers.', 'en', 1),
('txtMentionTurnStartSlow', '🔵 **Your turn has started in [story_title]!** You can now write your part of the story in your turn thread: [turn_thread_link]\n-# This is a slow mode story — there is no turn timer. Take your time!', 'en', 1),
...
('txtDMTurnReminderSlow', '🔵 **Friendly reminder:** You have an active turn in **[story_title]**. No rush — take your time! [Return to your turn thread]([turn_thread_link]) when you''re ready.', 'en', 1),
('txtMentionTurnReminderSlow', '🔵 **Friendly reminder:** You have an active turn in **[story_title]**. No rush — take your time! Return to your turn thread: [turn_thread_link]', 'en', 1),
