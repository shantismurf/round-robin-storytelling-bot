...
('txtRatingDesc', 'Filter M & E to NSFW channel (if set up)', 'en', 1),
...
('txtSceneBreakDividerDesc', 'Set a row of symbols that can be inserted in entries', 'en', 1),
...
('txtGroundRulesDesc', 'Tone and conduct guidance writers agree to for this story.', 'en', 1),
