...
('txtRatingChangeConfirmTitle', '⚠️ Rating Change — Thread Migration Required', 'en', 1),
('txtRatingChangeConfirmBody', 'Changing the rating from **[old_rating]** to **[new_rating]** crosses the Mature/Explicit barrier. A new story thread will be created on the appropriate channel, and the old thread will be archived and locked.\n\nThis will take effect when you click **Save Settings**. You can revert this change before saving.', 'en', 1),
