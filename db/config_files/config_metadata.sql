...
('txtExportNoteBody', '<span class="meta-label">Export note:</span> This file was generated by Round Robin StoryBot. Timestamps from Discord (e.g. turn deadlines in entries) are not included. Story images are hosted on Discord''s CDN — if you need them to persist long-term, download and re-upload them to a permanent image host and update the links in this file.', 'en', 1),
