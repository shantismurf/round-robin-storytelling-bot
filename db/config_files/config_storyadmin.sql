...
('txtReviewTagsDesc', '-# Read and approve or reject submitted tags', 'en', 1),
('txtManageUsersDesc', '-# Change user settings: Pause or Remove a user, or change a user''s Pen Name, Notifications, and Turn Privacy', 'en', 1),
