...
('txtAdminHelpManageUser', 'Opens a writer management panel — pause, unpause, remove, or update their pen name using buttons.', 'en', 1),
...
('txtAdminHelpSetup', 'Configure Round Robin StoryBot for this server — set the story feed channel, media channel, admin role, and weekly roundup settings.', 'en', 1),
...
-- Moved from config_other: storyadmin/manage-user/turn-action keys
...
('lblAdminHelpManageUser', '/storyadmin user [story_id] [user]', 'en', 1),
...
('txtFaqSyncSuccess', '✅ FAQ posts updated successfully.', 'en', 1),
('txtFaqSyncNoThreads', '⚠️ No FAQ thread IDs are configured. Set them via `/storyadmin setup`.', 'en', 1),
('txtFaqSyncPartial', '⚠️ FAQ sync complete with [error_count] error(s). Check logs for details.', 'en', 1);