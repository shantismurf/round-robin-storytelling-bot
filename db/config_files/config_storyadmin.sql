...
('btnSetupRole', 'Set Story Admin Role', 'en', 1),
...
('txtSetupEmbedDescMedia', '-# A private channel for storing story images. If not set, image handling in stories is disabled. (Optional)', 'en', 1),
('txtSetupEmbedDescAdminRole', '-# If not set, only Discord server admins can use storyadmin commands. (Optional)', 'en', 1),
('txtSetupEmbedDescRestrictedFeed', '-# A channel for Mature or Explicit works. Should be age-restricted if your server is not 18+. (Optional)', 'en', 1),
('txtSetupEmbedDescRestrictedMedia', '-# A private channel for storing restricted feed story images. (Optional)', 'en', 1),
...
('txtSetupModalTitleRole', 'Story Admin Role', 'en', 1),
...
('lblSetupModalFieldRole', 'Story Admin Role Name', 'en', 1),
