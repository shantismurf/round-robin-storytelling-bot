...
('txtSetupEmbedDescRestrictedMedia', '-# A private channel for storing restricted story images. If the channel is not set, image handling defaults to Story Media Channel. (Optional)', 'en', 1),
...
('txtSetupModalTitleMedia', 'Story Media Channel', 'en', 1),
('txtSetupModalTitleRole', 'Story Admin Role', 'en', 1),
('txtSetupModalTitleRestrictedFeed', 'Restricted Story Feed Channel', 'en', 1),
('txtSetupModalTitleRestrictedMedia', 'Restricted Story Media Channel', 'en', 1),
