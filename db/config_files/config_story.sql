...
('lblNoHours', 'Delay by # of Hours (if applicable):', 'en', 1),
('lblNoWriters', 'Delay until # of Writers (if applicable):', 'en', 1),
...
('btnAddTitleAndSummary', 'Edit Title and Summary', 'en', 1),
('btnAddStoryInfo', 'Edit Story Info', 'en', 1),
('btnAddSettings', 'Edit Story Settings', 'en', 1),
('btnAddMetadata', 'Edit Story Metadata', 'en', 1),
('btnAddTags', 'Edit Story Tags', 'en', 1),
...
('lblManageUnsavedChangesTitle', '⚠️ Unsaved Changes', 'en', 1),
('txtManageUnsavedChangesBody', 'You have changes that haven''t been saved yet. Click **[save_label]** below to keep them.', 'en', 1),
