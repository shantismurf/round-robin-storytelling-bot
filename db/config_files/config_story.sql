...
('lblNoWriters', '👥 Delay Start until # of Writers (optional) 👥', 'en', 1),
...
('btnPanelTabStoryInfo', 'Story Info', 'en', 1),
('btnPanelTabSettings', 'Story Settings', 'en', 1),
...
('txtJoinNotificationsDesc', 'Mentions post in main story feed', 'en', 1),
('lblJoinPrivacy', '🔏 Turn Thread Privacy 🔏', 'en', 1),
('txtJoinPrivacyDesc', 'Override story privacy setting for your turns', 'en', 1),
...
('txtStoryAddSectionBreakJoin', '## 🤝 My Join Settings', 'en', 1),
