...
| File | Status | Summary |
|---|---|---|
| [PLAN-manage-entries-consolidation.md](plans/PLAN-manage-entries-consolidation.md) | Implemented | Manage Entries rebuilt to reuse the Edit engine (fixes truncation, Back-button, delete/restore); adds an author entry picker to `/story edit` |
| [PLAN-story-list-overhaul.md](plans/PLAN-story-list-overhaul.md) | Pending | `/story list` layout/filter overhaul |
| [PLAN-story-privacy.md](plans/PLAN-story-privacy.md) | Shelved 2026-09-22 | Writer-only (private) stories, create-only toggle |
| [PLAN-hub-sharing.md](plans/PLAN-hub-sharing.md) | Deferred 2026-09-22 — partially implemented | Hub server story mirroring, consent, broadcast system |
...
| [PLAN-first-run-experience.md](plans/PLAN-first-run-experience.md) | Partially Implemented — copy shipped 2026-09-22 | Stage 2 build plan: Join button on the creation announcement, first-setup welcome post, story start button, invite affordances, guided tutorial |
| [PLAN-roundup-open-stories.md](plans/PLAN-roundup-open-stories.md) | Designed 2026-09-23, not built | An open-for-joining section in the weekly roundup, with up to five Join buttons and `/story list` as the overflow path |
...
| [PLAN-dm-support.md](plans/PLAN-dm-support.md) | Deferred indefinitely 2026-09-22 | Full DM-based story participation |
| [PLAN-series-system.md](plans/PLAN-series-system.md) | Idea — revisit | Group stories into a series with chapters |
| [PLAN-reactions-kudos.md](plans/PLAN-reactions-kudos.md) | Idea — revisit | Reaction-based kudos reposted to the story feed |
